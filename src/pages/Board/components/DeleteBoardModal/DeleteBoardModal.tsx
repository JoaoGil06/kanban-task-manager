...
export const DeleteBoardModal = ({ boardTitle, isOpen, onClose, onClick }: DeleteBoardModalProps) => {
	return (
		<Modal isOpen={isOpen} onClose={onClose}>
			<ModalContainer>
				...
				<ActionsContainer>
					...
					<Button label='Delete' variant={ButtonVariant.Destructive} onClick={onClick} />
				</ActionsContainer>
			</ModalContainer>
		</Modal>
	);
